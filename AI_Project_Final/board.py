...
class BoardWindow(object):
    def setupUi(self, Gobblet,player1,player2,mode,difficulty1,difficulty2):
        ...
        #instance of game
        game_instance = Game()
        print(difficulty1,difficulty2)
        # if(mode == "PVC"):
        Computer1 = ComputerPlayer(difficulty1, 0)
        Computer2 = ComputerPlayer(difficulty2, 1)
        ...
        if (mode == "PVP" or mode == "PVC"):
            ...
            self.down_finger.show()
            self.up_finger.hide()
            self.down_finger.mousePressEvent = lambda event : self.ComputerTurn(event, Player1_WhiteButtons, Player2_BlackButtons, boardButtons, playerRound, player1, player2, game_instance, mode, Computer1, Computer2)        
        ...
        if( mode == "PVP"):
            ...
            if (playerRound == "player1"):
               # QSound.play("Images/mario-jump-sound-effect.wav")
                ...
                for btn in Player2_BlackButtons:
                        btn.setEnabled(True)
                #self.up_finger.mousePressEvent = lambda event : self.ComputerTurn(event, Player1_WhiteButtons, Player2_BlackButtons, boardButtons, playerRound, player1, player2, game_instance, mode, Computer1, Computer2)        
    ...
    def ComputerTurn(self, event, Player1_WhiteButtons, Player2_BlackButtons, boardButtons, playerRound, player1, player2, game_instance, mode, Computer1, Computer2):
        ...
        print(b_Index)
        if (playerRound == "player1"):
            self.placeButton(event, boardButtons[b_Index], Player1_WhiteButtons, Player2_BlackButtons, boardButtons, Player1_WhiteButtons[g_Index], playerRound,player1,player2,game_instance, mode, Computer1, Computer2)
        elif (playerRound == "player2"):
