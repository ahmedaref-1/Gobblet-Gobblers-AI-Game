# Importing the Gobblet class from the Gobblet module
import Gobblet


# Defining a class named BoardItem
class BoardItem:
    ...
    def get_Board_Index(self):
        """
        Get the index of the board item.

        Returns:
        - The index of the board item.
        """
        return self.Index
